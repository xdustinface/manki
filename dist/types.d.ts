export declare const MAX_AGENT_RETRIES = 1;
 ...
 */
export declare function migrateLegacySeverity(severity: string): FindingSeverity | string;
/** Regex source matching all current and legacy severity tokens. */
export declare const SEVERITY_TOKEN_PATTERN = "blocker|warning|suggestion|nitpick|ignore|required|nit";
export type FindingReachability = 'reachable' | 'hypothetical' | 'unknown';
export declare const DEFENSIVE_HARDENING_TAG: "defensive-hardening";
export declare const RATCHET_SUPPRESSED_TAG: "suppressed-by-ratchet";
export declare const CONTRADICTION_TAG: "contradicts-prior-round";
export declare const OWN_PROPOSAL_TAG: "own-proposal-followup";
export declare const IN_PR_SUPPRESSED_TAG: "suppressed-in-pr";
/**
